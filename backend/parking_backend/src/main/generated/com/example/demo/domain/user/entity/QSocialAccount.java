...
public class QSocialAccount extends EntityPathBase<SocialAccount> {
    ...
    private static final long serialVersionUID = -569519064L;
    ...
    public final EnumPath<com.example.demo.domain.user.enums.Provider> provider = createEnum("provider", com.example.demo.domain.user.enums.Provider.class);
