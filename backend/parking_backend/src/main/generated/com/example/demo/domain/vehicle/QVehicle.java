...
public class QVehicle extends EntityPathBase<Vehicle> {
    ...
    private static final long serialVersionUID = 1364285722L;
    ...
    public final EnumPath<com.example.demo.domain.vehicle.enums.VehicleStatus> status = createEnum("status", com.example.demo.domain.vehicle.enums.VehicleStatus.class);
