...
public class QTicketPolicy extends EntityPathBase<TicketPolicy> {
    ...
    private static final long serialVersionUID = 2090703605L;
    ...
    public final EnumPath<com.example.demo.domain.shared.ticketPolicy.enums.DiscountType> discountType = createEnum("discountType", com.example.demo.domain.shared.ticketPolicy.enums.DiscountType.class);
    ...
    public final EnumPath<com.example.demo.domain.shared.ticketPolicy.enums.Status> status = createEnum("status", com.example.demo.domain.shared.ticketPolicy.enums.Status.class);

    public final NumberPath<Long> ticketPolicyId = createNumber("ticketPolicyId", Long.class);

    public final EnumPath<com.example.demo.domain.shared.ticketPolicy.enums.UseType> useType = createEnum("useType", com.example.demo.domain.shared.ticketPolicy.enums.UseType.class);
