...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = -1258942311L;
    ...
    public final EnumPath<com.example.demo.domain.resident.enums.Status> status = createEnum("status", com.example.demo.domain.resident.enums.Status.class);
