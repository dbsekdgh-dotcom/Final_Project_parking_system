...
public class QPayment extends EntityPathBase<Payment> {
    ...
    private static final long serialVersionUID = -188088923L;
    ...
    public final EnumPath<com.example.demo.domain.shared.payment.enums.PaymentMethod> paymentMethod = createEnum("paymentMethod", com.example.demo.domain.shared.payment.enums.PaymentMethod.class);

    public final EnumPath<com.example.demo.domain.shared.payment.enums.PaymentStatus> paymentStatus = createEnum("paymentStatus", com.example.demo.domain.shared.payment.enums.PaymentStatus.class);

    public final EnumPath<com.example.demo.domain.shared.payment.enums.PaymentType> paymentType = createEnum("paymentType", com.example.demo.domain.shared.payment.enums.PaymentType.class);
