...
public class QReport extends EntityPathBase<Report> {
    ...
    private static final long serialVersionUID = -1848960104L;
    ...
    public final com.example.demo.domain.shared.user.QUser reporter;
    ...
    public QReport(Class<? extends Report> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reporter = inits.isInitialized("reporter") ? new com.example.demo.domain.shared.user.QUser(forProperty("reporter"), inits.get("reporter")) : null;
    }
