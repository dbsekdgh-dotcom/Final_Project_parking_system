...
public class QAdminActionLog extends EntityPathBase<AdminActionLog> {
    ...
    private static final long serialVersionUID = 1903008155L;
    ...
    public final EnumPath<com.example.demo.domain.admin.enums.ActionType> actionType = createEnum("actionType", com.example.demo.domain.admin.enums.ActionType.class);
    ...
    public final EnumPath<com.example.demo.domain.admin.enums.TargetType> targetType = createEnum("targetType", com.example.demo.domain.admin.enums.TargetType.class);
