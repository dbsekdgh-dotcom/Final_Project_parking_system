...
public class QHousehold extends EntityPathBase<Household> {
    ...
    private static final long serialVersionUID = -1360011774L;
    ...
    public final EnumPath<com.example.demo.domain.resident.household.enums.IsActive> isActive = createEnum("isActive", com.example.demo.domain.resident.household.enums.IsActive.class);
