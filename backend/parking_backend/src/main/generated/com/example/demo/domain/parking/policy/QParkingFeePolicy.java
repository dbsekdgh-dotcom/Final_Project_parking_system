package com.example.demo.domain.parking.policy;
...
public class QParkingFeePolicy extends EntityPathBase<ParkingFeePolicy> {
    ...
    private static final long serialVersionUID = 67559286L;
    ...
    public final EnumPath<com.example.demo.domain.parking.policy.enums.ParkingType> parkingType = createEnum("parkingType", com.example.demo.domain.parking.policy.enums.ParkingType.class);
