...
public class QSubscription extends EntityPathBase<Subscription> {
    ...
    private static final long serialVersionUID = 1029253461L;
    ...
    public final EnumPath<com.example.demo.domain.shared.subscription.enums.Status> status = createEnum("status", com.example.demo.domain.shared.subscription.enums.Status.class);
