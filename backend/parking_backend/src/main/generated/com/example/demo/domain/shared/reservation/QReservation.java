...
public class QReservation extends EntityPathBase<Reservation> {
    ...
    private static final long serialVersionUID = -661367503L;
    ...
    public final EnumPath<com.example.demo.domain.shared.reservation.enums.Purpose> purpose = createEnum("purpose", com.example.demo.domain.shared.reservation.enums.Purpose.class);

    public final NumberPath<Long> reservationId = createNumber("reservationId", Long.class);

    public final EnumPath<com.example.demo.domain.shared.reservation.enums.Status> status = createEnum("status", com.example.demo.domain.shared.reservation.enums.Status.class);
