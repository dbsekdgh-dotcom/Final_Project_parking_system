...
public class QApproval extends EntityPathBase<Approval> {
    ...
    private static final long serialVersionUID = -797656171L;
    ...
    public final EnumPath<com.example.demo.domain.shared.approval.enums.ApprovalType> approvalType = createEnum("approvalType", com.example.demo.domain.shared.approval.enums.ApprovalType.class);
    ...
    public final com.example.demo.domain.shared.user.QUser requestUserId;

    public final EnumPath<com.example.demo.domain.shared.approval.enums.ApprovalStatus> status = createEnum("status", com.example.demo.domain.shared.approval.enums.ApprovalStatus.class);
    ...
    public QApproval(Class<? extends Approval> type, PathMetadata metadata, PathInits inits) {
        ...
        this.requestUserId = inits.isInitialized("requestUserId") ? new com.example.demo.domain.shared.user.QUser(forProperty("requestUserId"), inits.get("requestUserId")) : null;
    }
