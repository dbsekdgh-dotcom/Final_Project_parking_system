...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = 1426011413L;
    ...
    public final EnumPath<com.example.demo.domain.shared.user.enums.Status> status = createEnum("status", com.example.demo.domain.shared.user.enums.Status.class);
