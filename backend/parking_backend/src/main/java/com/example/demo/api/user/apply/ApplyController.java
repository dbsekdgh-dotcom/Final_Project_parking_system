package com.example.demo.api.user.apply;

import com.example.demo.domain.resident.apply.dtos.request.ResidentApplyRequestDto;
import com.example.demo.domain.resident.apply.dtos.response.*;
import com.example.demo.domain.resident.apply.service.ResidentApplyService;
import com.example.demo.domain.resident.apply.service.HouseholdFindService;
