...
import com.example.demo.domain.resident.apply.dtos.response.AvailableUnitResponseDto;
import com.example.demo.domain.resident.apply.dtos.response.HouseholdListResponseDto;
import com.example.demo.domain.resident.apply.dtos.response.UnitStatusResponseDto;
