...
import com.example.demo.domain.payment.ticket.Status;
...
public class ParkingLogService {
    ...
    public ParkingLogDetailResponse getParkingLogDetail(Long parkingLogId){
        ...
        if(log.getParkingTypeSnapshot().equals(ParkingTypeSnapshot.RESERVATION)){
            ...
            if(reservationRepository.getCountbyCarNumber(log.getCarNumberSnapshot(), com.example.demo.domain.reservation.enums.Status.ENTERED,true)<=0){
