...
const FindAccountButtons = ({ currentEmail = '' }) => {
    return (
        <div className="bottomRow" style={{ display: 'flex', justifyContent: 'center', gap: '10px', marginTop: '20px', fontSize: '14px', color: '#666' }}>
            ...
            <span>|</span>
            <button type="button" onClick={() => openFindPwModal(currentEmail)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'inherit' }}>
                비밀번호 찾기
            </button>
        </div>
    );
