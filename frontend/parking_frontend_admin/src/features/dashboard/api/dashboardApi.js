...
export const getSummary = () =>
    adminApi.get('/dashboard/summary').then(r => r.data);
// 매출 현황 그래프
...
export const getUsage = (type = 'PARKING') =>
    adminApi.get('/dashboard/usage',{ params: { type } }).then(r => r.data);
...
export const getUsageDetail = (type = 'PARKING', page = 0, size = 5) =>
    adminApi.get('/dashboard/usage/detail',{ params: { type, page, size } }).then(r => r.data);
